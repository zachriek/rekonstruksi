...
})({"jgwyO":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d4a41aff0f0dab4e";
...
},{}],"9KQSg":[function(require,module,exports) {
...
`;
   ...
   */ const removeCustomClasses = (elem, params)=>{
        Array.from(elem.classList).forEach((className)=>{
            if (!Object.values(swalClasses).includes(className) && !Object.values(iconTypes).includes(className) && !Object.values(params.showClass || {
            }).includes(className)) elem.classList.remove(className);
        });
    };
    /**
   * @param {HTMLElement} elem
...
`.replace(/(^|\n)\s*/g, '');
   ...
   */ const showInput = (params)=>{
        if (!renderInputType[params.input]) {
            error1(`Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "${params.input}"`);
            return;
        }
   ...
   */ const renderIcon = (instance, params)=>{
        ...
        if (params.icon && Object.keys(iconTypes).indexOf(params.icon) === -1) {
            error1(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${params.icon}"`);
            hide(icon);
            return;
        }
        show(icon);
...
`;
   ...
   */ var privateMethods = {
    ...
    /* istanbul ignore file */ // @ts-ignore
   ...
   */ const handleInputOptions = (instance, params)=>{
     ...
     */ const processInputOptions = (inputOptions)=>{
        ...
        else error1(`Unexpected type of inputOptions! Expected object, Map or Promise, got ${typeof params.inputOptions}`);
    };
    /**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */ const handleInputValue = (instance, params)=>{
        ...
        asPromise(params.inputValue).then((inputValue)=>{
            ...
            error1(`Error in inputValue promise: ${err}`);
            input.value = '';
            show(input);
            input.focus();
            instance.hideLoading();
   ...
   */ const handleConfirmOrDenyWithInput = (instance, type)=>{
        ...
        if (!innerParams.input) {
            error1(`The "input" parameter is needed to be set when using returnInputValueOn${capitalizeFirstLetter(type)}`);
            return;
        }
   ...
   */ const disposeSwal = (instance)=>{
        ...
        delete globalState1.keydownTarget;
   ...
   */ const isAnyButtonShown = (innerParams)=>{
    ...
    const argsToParams = (args)=>{
        ...
        if (typeof args[0] === 'object' && !isElement(args[0])) Object.assign(params, args[0]);
            ...
            else if (arg !== undefined) error1(`Unexpected type of ${name}! Expected "string" or "Element", got ${typeof arg}`);
        });
        return params;
    };
    /**
   ...
   */ const focusButton = (domCache, innerParams)=>{
    ...
    SweetAlert.prototype.rejectPromise = rejectPromise1;
...
},{}]},["jgwyO","9KQSg"], "9KQSg", "parcelRequire7dae")

//# sourceMappingURL=game2.0f0dab4e.js.map
